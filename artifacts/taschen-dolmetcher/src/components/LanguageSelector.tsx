  ...
  return (
    ...
    >
      <div className='w-[90%] flex justify-center mt-5 mb-5 gap-[1.5rem] md:gap-10 m-auto'>
        <div>
          ...
          <div className='md:max-w-[200px]'>
            <Select value={fromLanguage} onValueChange={handleFromLanguageChange}>
              ...
              <SelectContent>
                <SelectItem value="ru">
                  <img src={russianFlag} alt="Soviet flag" className='w-8 grayscale' />
                  русский
                </SelectItem>
                <SelectItem value="de" className="flex items-center gap-2">
                  <img src={germanFlag} alt="German flag" className='w-8 grayscale' />
                  Deutsch
                </SelectItem>
                <SelectItem value="en">
                  <img src={usFlag} alt="American flag" className='w-8 grayscale' />
                  English
                </SelectItem>
              </SelectContent>
            </Select>
        ...
        >
          <svg
            className='stroke-stone-300 fill-red-500'
            focusable="false"
