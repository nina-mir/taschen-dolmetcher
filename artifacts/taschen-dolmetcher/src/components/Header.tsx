  ...
  return (
    ...
    ">
      ...
      <img
        ...
        alt=""
        aria-hidden="true"
        className='w-25 md:w-20 fixed -bottom-4 rotate-10 md:-right-4 -right-13 fill-red-600'
      />
      <img
        src={taschen2}
        alt=""
        aria-hidden="true"
        className='w-25 md:w-30 fixed -bottom-5 md:-bottom-8 -rotate-5 md:-left-14 -left-11'
      />
      <img
        src={taschen1}
        alt=""
      ...
      <img
        ...
        alt=""
        aria-hidden="true"
        className='w-40 md:w-50 fixed -right-20 md:-right-25 top-60 md:top-9'
      />
